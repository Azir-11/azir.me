  ...
  <div class="max-w-300 mx-auto">
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div flex="~ gap-2 justify-center">
        <a
          href="https://github.com/Azir-11?tab=repositories&type=source"
          target="_blank"
      ...
      >
        ...
        >
          <div v-if="item.icon" class="pt-2 pr-5">
            ...
            <Soybean v-else-if="item.icon === 'Soybean'" class="w-9 max-w-9 h-9 saturate-0" />
            <GinVueAdmin v-else-if="item.icon === 'GinVueAdmin'" class="w-9 max-w-9 h-9 saturate-0" />
            <ChatGPTDesktop v-else-if="item.icon === 'ChatGPTDesktop'" class="w-9 max-w-9 h-9 saturate-0" />
